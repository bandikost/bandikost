              ...
              <ul className="space-y-2">
                {groupedFilms[letter].map(film => (
                  <li key={film.id} className="text-sm flex mb-8">
                    <Link target='_blank' to={film.link} className='p-1 md:text-xl flex flex-col font-bold'>{film.name} 
                    <span className='text-sm ml-4 mt-2 w-56 sm:w-96 font-light text-blue-500 underline hover:text-blue-700'>Перейти</span>
