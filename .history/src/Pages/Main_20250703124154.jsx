                        ...
                        {projects.map((proj) => (
                            ...
                            <li className="text-white flex flex-col justify-between list-none  font-ubuntu " key={proj.id}>
                                <p className="border rounded-xl  p-5 w-48 h-48 mt-5 mb-1">{proj.name}</p>
                                 <NavLink to={"works/:"} className="text-low-size text-white mr-5">→ <span className="transform duration-100 underline hover:text-indigo-300">Перейти в раздел</span></NavLink>
                            </li>
