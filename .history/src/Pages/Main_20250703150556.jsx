            ...
            <div className="container mx-auto px-4 md:flex md:items-end md:flex-col h-full">
                <p className="font-ubuntu text-ideal-phone sm:text-[2rem] text-white text-center w-82">Проекты, которые я создал: </p> 
                    <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        {projects.map((proj) => (
                            <li className="text-white flex flex-col items-center justify-between list-none  font-ubuntu text-ideal-phone sm:text-sm md:text-size-small-medium" style={{ backgroundImage: `url(${proj.src})` }} key={proj.id}>
