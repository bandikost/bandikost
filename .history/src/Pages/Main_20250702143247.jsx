         ...
         <VantaBackground>
            <section className={`h-12 ${s.parallax}`}>
                <div className={`flex flex-col items-center md:flex-row sm:mt-[0px] md:mt-[100px] ${s.welcomeSection}`}>                 
                    <div className={`font-normal ml-10 w-72 sm:w-[400px] ${s.title}`} >
                    ...
                    <img className=" w-56 h-56 mt-20 sm:mt-10 sm:w-72 sm:h-72 md:w-72 md:h-72 lg:w-96 lg:h-72" src={SoloRiver} loading="lazy" alt="My archive" />
                </div>                
            </section>
        </VantaBackground>
        <Slasher />  
