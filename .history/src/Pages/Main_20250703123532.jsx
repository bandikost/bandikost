            ...
            <section className="relative w-full h-120 flex bg-gray-900">
                ...
                <div className="ml-10"><p className="text-size font-ubuntu text-white pb-5">Проекты фриланса и для компаний, в которых я работал: </p> 
                    <ul className="grid grid-cols-3 gap-3">
                        {projects.map((proj) => (
                            <>
                            <li className="text-white flex flex-col justify-between list-none border font-ubuntu  p-5 w-48 h-48" key={proj.id}>
                                <p className="rounded-xl">{proj.name}</p>
                                 <NavLink className="text-ideal-phone text-white">Перейти в раздел</NavLink>
                            </li>
