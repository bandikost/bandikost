...
export default function Films() {
    ...
    const background = `https://image.tmdb.org/t/p/original${favorite[currentIndex]?.poster_path || ''}`;
    ...
    <h2 className="font-bold text-xl md:text-3xl my-10">Мои рецензии к фильмам</h2>
      ...
      <div className="w-full px-20 " style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover',
        backgroundPosition: 'center', minHeight: '400px',}}>
        <FavoriteFilms currentIndex={currentIndex} setCurrentIndex={setCurrentIndex} />
      </div>
