    ...
    return (
       ...
       <section className="relative w-full h-screen flex items-start bg-gray-900">
            <div className="flex">
                ...
                <div className="ml-5">
                    <ul className="font-ubuntu text-size text-white flex items-start flex-col">Сайт полностью SPA
                        {codeForSPA.map((c) => (
                            <li key={c.id} className="ml-10 text-left p-0 m-0 text-size-small-medium w-full list-decimal ">{c.name}</li>
                        ))}
                    </ul>
