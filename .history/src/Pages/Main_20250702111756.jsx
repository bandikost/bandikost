    ...
    <Suspense fallback={<Preloader />}>          
        <VantaBackground>
          ...
          <section className="relative w-full h-100 flex justify-end bg-gray-900">
                ...
                <div className="ml-10"><p className="text-size text-white text-left pb-5">Используемые технологии: <sub className="text-xs">наведи на них, чтобы узнать, что это</sub></p> 
