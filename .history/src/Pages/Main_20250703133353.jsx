    ...
    <Suspense fallback={<Preloader />}>          
        ...
        <Suspense fallback={<Preloader />}>
            ...
            <div className="container mx-auto px-4 md:flex md:justify-start items-center h-full">
                <div><p className="text-sm text-center flex items-center justify-center font-ubuntu text-white pb-5">Проекты фриланса и для компаний, в которых я работал: </p> 
