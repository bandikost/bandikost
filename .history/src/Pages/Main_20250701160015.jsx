    ...
    return (
       ...
       <section className="relative w-full h-screen flex items-start bg-gray-900">
            <div className="flex">
                ...
                <div className="ml-5">
                    <ul className="font-ubuntu text-size text-white list-decimal">Сайт полностью SPA
                        {codeForSPA.map((c) => (
                            <li key={c.id} className=" flex items-start p-0 m-0 text-size-small-medium w-full ml-10 ">{c.name}</li>
                        ))}
                    </ul>
