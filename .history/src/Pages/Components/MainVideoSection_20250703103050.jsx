                       ...
                       <div className="flex flex-col">
                        ...
                        <div className="ml-0 sm:ml-5">
                            <ul className="md:p-0 py-5 font-ubuntu text-to-title text-white flex items-center justify-center text-center lg:items-start flex-col md:text-lg w-82 ">Сайт на React (CRA)
                                {codeForSPA.map((c) => (
                                    <li key={c.id} className="mt-2 py-3 sm:text-sm md:text-lg sm:leading-none text-ideal-phone w-72 md:ml-10 text-right sm:text-left p-1 m-0 sm:text-size-small-medium md:text-sm sm:w-full list-decimal ">{c.name}</li>
                                ))}
                            </ul>
