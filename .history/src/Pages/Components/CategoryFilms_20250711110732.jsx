...
export default function CategoryFilms() {
  ...
  return (
    <>
      <NavLink to="/films" className="fixed top-[6.5%] w-96 left-[-10px] bg-white underline hover:text-blue-500 text-sm ml-3 flex items-center shadow-[5px_5px_10px_rgba(0,0,0,0.2)]">
