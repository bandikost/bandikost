                    ...
                    <div className="flex flex-col justify-center items-center">
                       ...
                       <div className="flex flex-col">
                        ...
                        <div className="ml-0 sm:ml-5">
                            <ul className="font-ubuntu text-to-title text-white flex items-center justify-center text-center lg:items-start flex-col w-82 "><p className="md:m-0 sm:my-5">Сайт на React (CRA)</p>
                                {codeForSPA.map((c) => (
