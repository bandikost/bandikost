         ...
         <section className="relative w-full h-120 flex bg-gray-900">
                    <div className="flex ">
                        ...
                        <div className="border border-indigo-300 rounded-xl">
                           <video className="w-48 h-32 sm:w-96 sm:h-56 md:w-96 md:h-56 lg:w-96 lg:h-56 object-cover rounded-xl" src={code} autoPlay loop muted playsInline/>
                        </div>
                        <div className="ml-5">
                            <ul className="font-ubuntu text-size text-white flex items-start flex-col md:text-lg sm:w-64">Сайт на React (CRA)
                                {codeForSPA.map((c) => (
