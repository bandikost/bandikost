         ...
         <section className="relative w-full h-120 flex bg-gray-900 justify-center items-center md:justify-start">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <div className="border border-indigo-300 rounded-xl ">
                           <video className="w-[300px] h-auto sm:max-w-[400px] md:max-w-96 md:h-auto lg:max-w-96 border-0 sm:border sm:rounded-xl" src={code} autoPlay loop muted playsInline/>
                        </div>
                        <div className="ml-5">
