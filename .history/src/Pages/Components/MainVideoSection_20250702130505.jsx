...
export default function MainVideo() {
    ...
    return (
         <section className="relative w-full h-120 flex bg-gray-900 justify-center items-center md:justify-end">
                    <div className="flex flex-col justify-center items-center">
                          <p className="text-size pb-5 text-white underline text-left ml-5">Code Review<sup className="text-xs pl-1">* Тут мы смотрим под капот</sup></p>
