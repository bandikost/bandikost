...
export default function CategoryFilms() {
  ...
  return (
    <>
      <NavLink to="/films" className="fixed top-[6.5%] w-full md:w-0 md:left-0 left-[-13px] bg-white underline hover:text-blue-500 text-sm ml-3 flex items-center shadow-[5px_5px_10px_rgba(0,0,0,0.2)]">
