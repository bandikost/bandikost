...
export default function CategoryFilms() {
  ...
  return (
    <>
      <NavLink to="/films" className="mb-4 underline hover:text-blue-500 text-sm ml-3 flex items-center">
        <img src={back} loading='lazy' alt="" />Вернуться
      </NavLink>

      <h1 className="text-xl font-bold mb-2 mt-20 flex flex-col items-center justify-center">
      ...
      <FilmsSorter
        filmsInCategory={filmsInCategory}
