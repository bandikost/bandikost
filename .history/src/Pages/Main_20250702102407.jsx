            ...
            <div className="flex">
                ...
                <div className="ml-10">
                    <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 ">
                         <li><img className="w-24 h-24 px-3" src={js} alt="" /></li>
                        <li><img className="w-24 h-24 px-3" src={rt} alt="" /></li>
                        <li><img className="w-24 h-24 px-3" src={ui} alt="" /></li>
                        <li><img className="w-24 h-24 px-3" src={axios} alt="" /></li>
                        <li><img className="w-24 h-24 px-3" src={jest} alt="" /></li>
                    </ul>
                </div>
