        ...
        <Slasher />  
          ...
          <section className="relative w-full h-[400px] center-flex bg-gray-900 md:flex md:justify-end">
                ...
                <div className="ml-10"><p className="text-size text-white text-right pb-5 ">Используемые технологии: </p> 
                    <ul className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-6 gap-4">
                        {skills.map((skill, i) => (
                            <li key={i}>
                            <img
                                className={`w-12 h-12 md:w-24 md:h-24 p-0 border border-gray-900 rounded-lg object-contain ${skill.bg}`}
                                src={skill.src}
                                alt={`skill-${i}`}
                            />
                            </li>
