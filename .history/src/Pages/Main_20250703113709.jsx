...
useLayoutEffect(() => {
    ...
    <Suspense fallback={<Preloader />}>          
         <VantaBackground>
            ...
            <Slasher >
                <div className="w-56 absolute mt-[-14px] sm:mt-[-14px] md:mt-[-17px] left-1/2 transform -translate-x-1/2 bg-indigo-300 z-10 center-flex border rounded-full">
                            <p className="center-flex text-gray-200 text-size-small-medium p-2 font-ubuntu mt-[-3px]">
