    ...
    <Suspense fallback={<Preloader />}>          
       {/*  <VantaBackground>
        ...
        <Slasher />  
          ...
          <section className="relative w-full h-[600px] sm:h-[400px] bg-gray-900 ">

                <div className="ml-10 "><p className="text-lg sm:text-size text-white text-center sm:text-right pb-5">Используемые технологии: </p> 
                    <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-6 gap-4 h-[500px] ">
                        {skills.map((skill, i) => (
                            <li key={i}>
                            <img
