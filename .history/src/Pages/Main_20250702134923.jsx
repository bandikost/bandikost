       ...
       {/*  <VantaBackground>
        ...
        <Slasher />  
          ...
          <section className="relative w-full h-[600px] sm:h-[400px] center-flex bg-gray-900 md:flex md:justify-end">
                ...
                <div className="ml-10 flex flex-col sm:flex-row"><p className="text-lg sm:text-size text-white text-center sm:text-right pb-5 w-96">Используемые технологии: </p> 
