...
export default function Films() {
   ...
   <li className="list-none realtive">
    <div class="grid mt-0 sm:mt-5 md:mt-5 grid-cols-2 sm:grid-cols-2 md:grid-cols-5">
            {categories.map((category, index) => (
                <li className="relative shadow-[5px_5px_10px_rgba(0,0,0,0.2)] 
                hover:bg-indigo-100 transition-colors duration-300 cursor-pointer m-4 list-decimal border p-4 
                rounded-xl shadow text-center font-medium bg-white " key={index}>
