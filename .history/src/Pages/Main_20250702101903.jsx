            ...
            <div className="flex">
                  <div className="ml-5">
                    <ul className="font-ubuntu text-size text-white flex justify-end flex-col">Используемые технологии: 
                        {codeForSPA.slice(5, 10).map((c) => (
                            <li key={c.id} className="text-left p-1 m-0 text-size-small-medium w-full list-decimal ">{c.name}</li>
                        ))}
                    </ul>
                ...
                <div className="">
                    <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 ">
                        ...
                        <li><img className="w-24 h-24" src={rt} alt="" /></li>
                        <li><img className="w-24 h-24" src={ui} alt="" /></li>
                        <li><img className="w-24 h-24" src={axios} alt="" /></li>
                        <li><img className="w-24 h-24" src={jest} alt="" /></li>
                    </ul>
                </div>
