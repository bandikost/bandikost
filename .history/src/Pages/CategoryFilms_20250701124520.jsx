                ...
                {groupedFilms[letter].map(film => (
                  <li key={film.id} className="text-sm flex mb-8 flex-col">
                    ...
                    <p className='p-1 md:text-xl font-bold'>{film.name}
                      <Link target='_blank' to={film.link} className='font-bold text-sm ml-3 w-56 sm:w-96 font-light text-indigo-400 underline hover:text-blue-700'>Перейти на imdb</Link>
                    </p>
