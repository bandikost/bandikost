      ...
      >
        ...
        <div class="grid grid-cols-3 mt-5 ">
            {categories.map((category, index) => (
                <li className="hover:bg-indigo-100 w-16 transition-colors duration-300 cursor-pointer m-4 list-decimal border p-4 rounded-xl shadow text-center font-medium bg-white space-y-2" key={index}>
