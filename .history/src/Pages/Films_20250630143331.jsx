...
import films, { lastUpdated } from "../Components/Arrays/films"
...
export default function Films() {
    ...
    <MyToolTip text="Это подсказка"><h1 className="mt-10 font-bold">Последнее обновление фильма: {formattedDate}</h1></MyToolTip>
