...
export default function Films() {
    ...
    <div className="m-0 flex flex-col items-center mt-20 w-full">
   ...
   <li className="list-none realtive">
        <FilmPoster
          className="relative  left-1/2 -translate-x-1/2 w-[960px] h-[480px] object-contain blur rounded-xl"
          filmName={favorite[currentIndex].name}
          year={favorite[currentIndex].year}
        />
        <div className="relative right-1/4 top-1/2 -translate-y-1/2 z-10">
    <FavoriteFilms />
  </div>
      </li>
