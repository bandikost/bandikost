    ...
    <Suspense fallback={<Preloader />}>          
       {/*  <VantaBackground>
        ...
        <Slasher />  
          ...
          <section className="relative w-full h-[500px] center-flex bg-gray-900 md:flex md:justify-end">

                <div className="ml-10"><p className="text-size text-white text-right pb-5 ">Используемые технологии: </p> 
                    <ul className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-6 gap-4 h-[500px]">
                        {skills.map((skill, i) => (
                            <li key={i}>
                            <img
