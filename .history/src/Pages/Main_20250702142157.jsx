    ...
    <Suspense fallback={<Preloader />}>          
         <VantaBackground>
            <section className={`h-12 ${s.parallax}`}>
                <div className={`flex flex-col ${s.welcomeSection}`}>                 
                    ...
                    <img className="flex items-center justify-center w-72 h-56 sm:w-96 sm:h-72 md:w-96 md:h-72 lg:w-96 lg:h-72" src={SoloRiver} loading="lazy" alt="My archive" />
                </div>                
            </section>
        </VantaBackground>
        <Slasher />  
