...
useLayoutEffect(() => {
    ...
    <Suspense fallback={<Preloader />}>          
        ...
        <div className="container mx-auto px-4 md:flex md:justify-end items-center flex justify-center h-full">
                <div className="ml-5 md:ml-10"><p className="font-ubuntu text-to-title text-white flex items-center justify-center text-center lg:items-start flex-col w-82 ">Используемые технологии: </p> 
