...
useLayoutEffect(() => {
    ...
    <Suspense fallback={<Preloader />}>          
        <VantaBackground>
          ...
          <section className="relative w-full h-120 flex justify-end bg-gray-900">

                <div className="ml-10"><p className="text-size text-white text-left pb-5">Используемые технологии: </p> 
            ...
            <section className="relative w-full h-120 center-flex  bg-gray-900">
                ...
                <div className="ml-10"><p className="text-size text-white text-left pb-5">Проекты: </p> 
                    <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                        {skills.map((skill, i) => (
                            <li key={i}>
                            <img
