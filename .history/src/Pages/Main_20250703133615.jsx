    ...
    <Suspense fallback={<Preloader />}>          
        ...
        <Suspense fallback={<Preloader />}>
            ...
            <div className="container mx-auto px-4 md:flex md:justify-start items-center h-full">
                <p className="md:text-2xl text-ideal-phone sm:text-2xl w-64 font-semibold text-white text-center font-ubuntu max-w-3xl mx-auto px-2">Проекты фриланса и для компаний, в которых я работал: </p> 
