    ...
    <Suspense fallback={<Preloader />}>          
         <VantaBackground>
            <section className={`h-12 ${s.parallax}`}>
                <div className={`flex flex-col items-center md:flex-row mt-[100px] sm:mt-[-50px] ${s.welcomeSection}`}>                 
                    <div className={`font-normal w-96 ${s.title}`} >
                    ...
                    <img className=" w-72 h-56 sm:mt-10 sm:w-72 sm:h-72 md:w-72 md:h-72 lg:w-96 lg:h-72" src={SoloRiver} loading="lazy" alt="My archive" />
                </div>                
            </section>
        </VantaBackground>
        <Slasher />  
