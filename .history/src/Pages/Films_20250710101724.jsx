...
export default function Films() {
    ...
    <h1 className=" font-bold text-xl md:text-3xl">Избранные:</h1>
      <ul className="mt-10 md:text-2xl mx-10 grid grid-cols-4 ">
        {favorite.map((fav) => (
            <li key={fav.id} className="flex items-center flex-col mx-3 pt-2 border rounded-xl font-normal 
            ...
            <FilmPoster className="absolute w-40" filmName={fav.name} year={fav.year} />
            {fav.name}
          </li> 
      ))}
    </ul>
