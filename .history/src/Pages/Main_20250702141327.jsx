         ...
         <VantaBackground>
            <section className={`h-12 ${s.parallax}`}>
                <div className={s.welcomeSection}>                 
                    <div className={`font-semibold ${s.title}`} >
                        <h1 className="font-ubuntu text-size-small-medium">Добро пожаловать ко мне в гости!</h1>
                        ...
                        <p className="font-ubuntu text-low-size text-size-small-medium"><sup>* </sup>Не удивляйтесь многим разделам, которые здесь могут присутствовать.</p>
                    </div>
                    <img className="w-72 h-56 sm:w-96 sm:h-56 md:w-96 md:h-72 lg:w-96 lg:h-72" src={SoloRiver} loading="lazy" alt="My archive" />
                </div>                
            </section>
        </VantaBackground>
        <Slasher />  
