...
import lastUpdated from "../Components/Arrays/films"
  ...
  return (
    <Toast.Provider swipeDirection="right">
      ...
      <Toast.Root duration={4000} open={open} onOpenChange={setOpen} className="bg-blue-500 text-white p-4 rounded shadow">
        <Toast.Title className="font-bold"><h1 className="mt-10 font-bold">Последнее обновление фильма: {formattedDate}</h1></Toast.Title>
