...
export default function Header() {
  ...
  return (
    <header className="fixed top-6 left-1/2 z-50 w-[95%] max-w-6xl -translate-x-1/2 rounded-2xl border border-gray-200 bg-white/80 shadow-lg backdrop-blur-xl">
      <div className="flex h-16 items-center justify-between px-6">
        <h1 className="text-lg font-bold text-zinc-500">
          bandikost  
        </h1>
