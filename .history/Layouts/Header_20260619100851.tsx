...
export default function Header() {
  ...
  return (
    <header className="fixed top-4 left-1/2 z-50 w-[95%] max-w-6xl -translate-x-1/2 rounded-2xl border border-white/20 bg-white/70 shadow-lg backdrop-blur-xl">
      <div className="flex h-16 items-center justify-between px-6">
        <h1 className="text-lg font-bold text-zinc-700">
          bandikost  {translations[lang].title}
        </h1>
