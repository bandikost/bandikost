...
export default async function Home() {
  ...
  <div className="space-y-4 text-zinc-600 leading-relaxed">
    <p>
      I started as a self-taught developer, building small React apps and UI components.
    </p>

    <p>
      Over the last 3 years I focused on building scalable frontend systems using Next.js, TypeScript and modern UI architecture.
    </p>

    <p>
      I care about performance, UX details and clean architecture.
    </p>
  </div>
</section>
<FadeIn>
