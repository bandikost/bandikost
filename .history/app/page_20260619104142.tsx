...
export default async function Home() {
  ...
  <div className="flex gap-3">
    <Link href="https://github.com/bandikost" className="px-5 py-2 rounded-xl bg-black text-white hover:bg-white hover:text-black">
      GitHub
    </Link>
    <Link href="bandikost@gmail.com" className="px-5 py-2 rounded-xl border">
      Contact
    </Link>
  </div>
</section>
