        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="rounded-2xl border bg-white/70 p-6 hover:-translate-y-1 transition">
            ...
            <div className="flex gap-2 mt-3 text-md">
              <span className="px-2 py-1 bg-zinc-200 rounded-xl">Next.js</span>
              <span className="px-2 py-1 bg-zinc-200 rounded-xl">Node.js</span>
              <span className="px-2 py-1 bg-zinc-200 rounded-xl">MySQL</span>
            </div>
          </div>
