      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="flex flex-wrap gap-2">
          {["React", "Next.js", "TypeScript", "Node.js"].map((s) => (
            <span key={s} className="px-3 py-2 text-lg rounded-full bg-zinc-100 text-sm text-zinc-700">{s}</span>
          ))}
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="rounded-2xl border bg-white/70 p-6 hover:-translate-y-1 transition">
            ...
            <div className="flex gap-2 mt-3 text-md">
              <span className="px-3 py-2 bg-zinc-100 rounded-xl">Next.js</span>
              <span className="px-3 py-2 bg-zinc-100 rounded-xl">Node.js</span>
              <span className="px-3 py-2 bg-zinc-100 rounded-xl">MySQL</span>
            </div>
          </div>
