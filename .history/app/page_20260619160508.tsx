...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-zinc-50 text-zinc-900 mt-10">
      ...
      <section className="min-h-[60vh] flex flex-col justify-center items-center text-center gap-6 px-4">
      ...
      <section className="max-w-5xl mx-auto px-4">
        <h2 className="text-2xl font-semibold mb-6">{translations[lang].aboutme}</h2>
