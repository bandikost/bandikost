         ...
         <section className="relative w-full h-84 flex bg-gray-900 justify-center items-center lg:justify-start">
                    <div className="flex flex-col justify-center items-center">
                       ...
                       <div className="flex flex-col">
                          <p className="text-size pb-5 text-white underline text-left ml-5 md:ml-0">Code Review <sup className="text-for-sups pl-1 text-white">* Тут мы смотрим под капот</sup></p>
